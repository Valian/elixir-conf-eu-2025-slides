defmodule ElixirconfLiveVue.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: ElixirconfLiveVue.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ElixirconfLiveVueWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
