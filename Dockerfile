...
# install mix & npm dependencies
COPY assets/package.json assets/package-lock.json ./assets/
COPY mix.exs mix.lock ./
RUN mix deps.get --only $MIX_ENV && mkdir config && npm ci --prefix assets
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/elixirconf_live_vue ./
